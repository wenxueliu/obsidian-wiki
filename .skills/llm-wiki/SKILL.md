...
steps:
  ...
  - id: design_architecture
    ...
    output: wiki-architecture.md（三层架构、Knowledge Profile/Layout、page/special-file schema）
    check_voting:
  ...
  - id: deliver_blueprint
    ...
    check_voting:
      ...
      - check: 从 llm-wiki contract 重查三层、Knowledge Profile/Layout 边界、schema、provenance/trust、retrieval、special files、QMD、config 和 operation boundaries，无内部矛盾
