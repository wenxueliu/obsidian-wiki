...
3. Check the source against the Profile scope, apply its extraction retain/omit policy, then split compatible content into atomic knowledge and select exactly one Profile-compatible declared page type per item using the active Knowledge Pack routing contract.
